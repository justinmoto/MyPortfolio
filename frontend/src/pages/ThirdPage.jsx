...
const ThirdPage = () => {
  const works = [
...

    {
      ...
      dev: ['Figma', 'Tailwind', 'NextJS', 'Vercel', 'JavaScript', 'NodeJS', 'Express', 'MySQL'],
      link: 'https://sg-cybersecurity-2025.vercel.app/LoginPage',
      icon: IoIosLink,
    },
    ...
    //Added a new project
    {
      ...
      info: 'Yuzo is a Massage Service Website',
      dev: ['Figma', 'React', 'Tailwind', 'Vercel'],
      link: 'https://yuzomassageservices.com/',
      icon: IoIosLink,
    },

    {
      ...
      title: 'Teatrack',
      info: 'Teatrack is Ordering System with Inventory Management and Bar Code Scanner for a Tea Shop',
      dev: ['Figma', 'NextJS', 'Tailwind', 'Vercel', 'JavaScript', 'NodeJS', 'Express', 'MySQL'],
      link: 'https://www.figma.com/proto/AZlJEHf9K0jNpRJFf6qP5E/Fortinet-Shopping?page-id=0%3A1&node-id=736-3000&viewport=6204%2C-684%2C0.13&t=pziFqhuSq7YYsjA5-1&scaling=min-zoom&content-scaling=fixed&starting-point-node-id=2452%3A8318',
      icon: IoIosLink,
    },

    {
      ...
      title: 'Smart Handog',
      info: 'Smart Handog is a platform where the resident of Taguig City can get their Ayuda by Scanning their QR Code',
      dev: ['Figma', 'NextJS', 'Tailwind', 'Vercel', 'JavaScript', 'NodeJS', 'Express', 'MySQL'],
      link: 'https://www.smarthandog.com/',
      icon: IoIosLink,
    },

    {
      ...
      title: 'Garment',
      info: 'A Inventory Management System for a Garment Shop',
      dev: ['Figma', 'HTML', 'CSS', 'JavaScript', 'PHP', 'MySQL'],
      link: 'https://www.figma.com/proto/AZlJEHf9K0jNpRJFf6qP5E/Fortinet-Shopping?page-id=0%3A1&node-id=736-3000&viewport=6204%2C-684%2C0.13&t=pziFqhuSq7YYsjA5-1&scaling=min-zoom&content-scaling=fixed&starting-point-node-id=2452%3A8318',
      icon: IoIosLink,
    },

    {
      ...
      title: 'Drivr',
      info: 'A Delivery Management System with GPS Tracking and Route Optimization.',
      dev: ['Figma', 'Tailwind', 'NextJS', 'Vercel', 'JavaScript', 'NodeJS', 'Express', 'MongoDB'],
      link: 'https://www.figma.com/proto/AZlJEHf9K0jNpRJFf6qP5E/Fortinet-Shopping?page-id=0%3A1&node-id=736-3000&viewport=6204%2C-684%2C0.13&t=pziFqhuSq7YYsjA5-1&scaling=min-zoom&content-scaling=fixed&starting-point-node-id=2452%3A8318',
      icon: IoIosLink,
    },
