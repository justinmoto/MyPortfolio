...
const SecondPage = () => {
  const development = [
    ...
    {src: '../src/assets/php.png', alt: 'PHP logo'},
    {src: '../src/assets/nodejs.png', alt: 'NodeJS logo'},
    {src: '../src/assets/npm.png', alt: 'NPM logo'},
    {src: '../src/assets/express.png', alt: 'Express logo'},
    {src: '../src/assets/unity.png', alt: 'Unity logo'},
    {src: '../src/assets/c.png', alt: 'C# logo'},
    {src: '../src/assets/java.png', alt: 'Java logo'},
  ]

  const tools = [
    {src: '../src/assets/figma.png', alt: 'Figma logo'},
    {src: '../src/assets/canva.png', alt: 'Canva logo'},
    {src: '../src/assets/mysql.png', alt: 'MySQL logo'},
    {src: '../src/assets/github.png', alt: 'GitHub logo'},
    {src: '../src/assets/xampp.png', alt: 'XAMPP logo'},
  ]
