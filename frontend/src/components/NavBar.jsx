...
const NavBar = () => {
  ...
  return (
    <div className=''>
      <ol className='flex space-x-20 bg-[#34353A] py-4 px-24 rounded-full relative z-20 xxs:hidden xs:hidden sm:hidden md:hidden lg:hidden xl:space-x-10 xl:px-16'>
